...
fname = 'C_calibration_k_constant';
hfig = figure(1);
...
% plot linear estimation of c
plot(lc2_x,c_constant_cool*ones(length(lc2_x),1),'--',LineWidth=3,Color=color_green);
plot(lh2_x,c_constant_heat*ones(length(lh2_x),1),'--',LineWidth=3,Color=color_purple);
hold off
hold off
...
save('./data4plot/Kconstant/C_constants_heat_k_constant.mat', 'C_constants_heat');
save('./data4plot/kconstant/C_constants_cool_k_constant.mat', 'C_constants_cool');
