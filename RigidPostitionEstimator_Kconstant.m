...
Kconstant_grav_est = [x;y];
plot(x,y,'-*r',MarkerSize=3,LineWidth=2)
...
load('./Previous-results/CaseByCase/Kconstant/C_1.mat');
load('./Previous-results/CaseByCase/Kconstant/C_2.mat');
load('./Previous-results/CaseByCase/Kconstant/C_3.mat');
load('./Previous-results/CaseByCase/Kconstant/C_4.mat');
...
%%
%
% load('./CaseByCase/Kconstant/pixel_angles_Cvariable.mat');
% load('./CaseByCase/Kconstant/final_angles_Cvariable.mat');
load('./CaseByCase/Kconstant/pixel_angles_Cconstant.mat');
load('./CaseByCase/Kconstant/final_angles_Cconstant.mat');
...
final_angles(i) = jacobian_matrix(i)/-spring_constants;
...
load('./CaseByCase/Kconstant/C_constants_cool_k_constant.mat');
C_val_cool = C_constants_cool';
load('./CaseByCase/Kconstant/C_constants_heat_k_constant.mat');
...
for i = 1 : length(jacobian_matrix)
final_angles(i) = (-1/spring_constants)*mat(i);
end
...
FF = waitbar(0,'Sample indx');
    ...
    for bruh2 = 1 : length(all_temp_ind)
        ...
        for i = 1 : length(angles_of_interest_start_ind)
            ...
            TWS(i) = k_tor_spring_rest*(angles_of_interest_ind(i)' - angles_of_interest_start_ind(i)'); % All torque on system excluding SMAs 
